...
export function Header() {
  ...
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent("Olá! Vi o site da Fast Rodas e gostaria de tirar algumas dúvidas.")}`;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button className="hidden md:flex items-center space-x-2 px-4 py-2 bg-[#1a1a1a] rounded-md text-white hover:bg-[#262626]">
              <Search className="w-4 h-4" />
              <span className="text-sm">{strings.header.search}</span>
            </button>
            
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="p-2 text-[#25D366] hover:scale-110 transition-transform">
